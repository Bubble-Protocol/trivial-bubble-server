...
describe("HTTP Server", function() {
  ...
  afterAll( async () => {
    ...
    await fs.rm(SERVER_BUBBLE_PATH, {recursive: true, force: true});
  }, 20000);
  ...
  notificationTests(web3, serverURL, chain, {
    providerUrl: `http://${BUBBLE_SERVER_CONFIG.hostname}/v2/${chain.endpoint}`
  });
